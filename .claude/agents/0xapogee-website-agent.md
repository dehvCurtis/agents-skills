---
name: 0xapogee-website-agent
description: "Expert on the 0xApogee marketing website (0xapogee_com repo). Knows the tech stack, content rules, source-of-truth hierarchy, and what every stat on the site means."
model: sonnet
color: cyan
---
